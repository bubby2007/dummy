...
st.set_page_config(
    page_title="Socioeconomic Status & Financial Hardship - Hushlytics",
    layout="wide",
...
st.markdown("<h1 class='title'>Socioeconomic Status & Financial Hardship</h1>", unsafe_allow_html=True)
st.markdown(
    "<p class='subtitle'>Understand economic challenges and develop targeted support strategies for your community.</p>",
    unsafe_allow_html=True
)
...
st.markdown(
    ...
    <div class="resource-card">
        ...
        <p style="color: #4a5568; margin-bottom: 1rem;">
            Access comprehensive socioeconomic resources, guidelines, and best practices for conducting surveys and analyzing data responsibly.
        </p>
...
st.markdown(
    '<p style="color: #718096; margin-bottom: 2rem;">Upload your socioeconomic survey data for analysis while maintaining complete privacy.</p>',
    unsafe_allow_html=True
)
