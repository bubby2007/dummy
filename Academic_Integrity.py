...
st.set_page_config(
    page_title="Academic Integrity & Performance",
    layout="wide",
    initial_sidebar_state="expanded"
)

# CSS styles consistent with Home.py
st.markdown(
    """
    <style>
...
st.markdown("<h1 class='title'>Academic Integrity & Performance</h1>", unsafe_allow_html=True)
st.markdown(
    "<p class='subtitle'>Evaluate academic honesty practices and identify areas for improving educational outcomes.</p>",
    unsafe_allow_html=True
)
...
st.markdown(
    ...
    <div class="resource-card">
        ...
        <p style="color: #4a5568; margin-bottom: 1rem;">
            Access comprehensive academic integrity resources, guidelines, and best practices for conducting surveys and analyzing data responsibly.
        </p>
...
st.markdown(
    '<p style="color: #718096; margin-bottom: 2rem;">Upload your academic integrity survey data for analysis while maintaining complete privacy.</p>',
    unsafe_allow_html=True
)
