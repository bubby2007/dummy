...
st.set_page_config(
    page_title="Diversity, Equality & Inclusion",
    layout="wide",
...
st.markdown("<h1 class='title'>Diversity, Equality & Inclusion</h1>", unsafe_allow_html=True)
st.markdown(
    "<p class='subtitle'>Assess inclusivity initiatives and gather insights to create a more equitable environment.</p>",
    unsafe_allow_html=True
)
...
st.markdown(
    ...
    <div class="resource-card">
        ...
        <p style="color: #4a5568; margin-bottom: 1rem;">
            Access comprehensive DEI resources, guidelines, and best practices for conducting surveys and analyzing data responsibly.
        </p>
...
st.markdown(
    '<p style="color: #718096; margin-bottom: 2rem;">Upload your diversity and inclusion survey data for analysis while maintaining complete privacy.</p>',
    unsafe_allow_html=True
)
